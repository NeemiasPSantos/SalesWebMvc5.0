...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
            ...
            public void Seed()
            {
                ...
                Seller s1 = new Seller(1, "Bob Bown", "bob@gmail.com", new DateTime(1998, 08, 08), 1000.0, d1);
                Seller s2 = new Seller(2, "Maria Still", "maria@gmail.com", new DateTime(1995, 05, 22), 1200.0, d3);
                Seller s3 = new Seller(3, "Muller Collins", "muller@gmail.com", new DateTime(1992, 01, 25), 1050.0, d2);
                Seller s4 = new Seller(4, "Diana Summer", "diana@gmail.com", new DateTime(2000, 07, 18), 1000.0, d4);
                Seller s5 = new Seller(5, "Robert Crab", "robert@gmail.com", new DateTime(1997, 05, 07), 1000.0, d1);
                Seller s6 = new Seller(6, "David BlackWood", "david@gmail.com", new DateTime(1993, 06, 13), 1050.0, d2);
